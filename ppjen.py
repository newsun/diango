...
def config(jobsName):
    assert isinstance(jobsName,list)
    permissionStr = "<hudson.security.AuthorizationMatrixProperty><permission>hudson.model.Item.Workspace:kejiang</permission><permission>hudson.model.Item.Workspace:tkahkonen</permission><permission>hudson.model.Item.Workspace:richuang</permission><permission>hudson.model.Item.Workspace:ltruong</permission><permission>hudson.model.Item.Workspace:tkhoo</permission><permission>hudson.model.Item.Workspace:anonymous</permission><permission>hudson.model.Item.Workspace:jvely</permission><permission>hudson.model.Item.Workspace:rlux</permission><permission>hudson.model.Item.Workspace:biwei</permission><permission>hudson.model.Item.Workspace:belzhang</permission><permission>hudson.model.Item.Workspace:sochoudhary</permission><permission>hudson.model.Item.Workspace:bozhou</permission><permission>hudson.model.Item.Workspace:lolu</permission><permission>hudson.scm.SCM.Tag:kejiang</permission><permission>hudson.scm.SCM.Tag:jvely</permission><permission>hudson.scm.SCM.Tag:rlux</permission><permission>hudson.scm.SCM.Tag:tkahkonen</permission><permission>hudson.scm.SCM.Tag:biwei</permission><permission>hudson.scm.SCM.Tag:sochoudhary</permission><permission>hudson.scm.SCM.Tag:belzhang</permission><permission>hudson.scm.SCM.Tag:richuang</permission><permission>hudson.scm.SCM.Tag:bozhou</permission><permission>hudson.scm.SCM.Tag:ltruong</permission><permission>hudson.scm.SCM.Tag:tkhoo</permission><permission>hudson.scm.SCM.Tag:lolu</permission><permission>hudson.model.Item.Delete:kejiang</permission><permission>hudson.model.Item.Delete:jvely</permission><permission>hudson.model.Item.Delete:rlux</permission><permission>hudson.model.Item.Delete:tkahkonen</permission><permission>hudson.model.Item.Delete:biwei</permission><permission>hudson.model.Item.Delete:sochoudhary</permission><permission>hudson.model.Item.Delete:belzhang</permission><permission>hudson.model.Item.Delete:richuang</permission><permission>hudson.model.Item.Delete:bozhou</permission><permission>hudson.model.Item.Delete:ltruong</permission><permission>hudson.model.Item.Delete:tkhoo</permission><permission>hudson.model.Item.Delete:lolu</permission><permission>hudson.model.Item.Configure:kejiang</permission><permission>hudson.model.Item.Configure:jvely</permission><permission>hudson.model.Item.Configure:rlux</permission><permission>hudson.model.Item.Configure:tkahkonen</permission><permission>hudson.model.Item.Configure:biwei</permission><permission>hudson.model.Item.Configure:sochoudhary</permission><permission>hudson.model.Item.Configure:belzhang</permission><permission>hudson.model.Item.Configure:richuang</permission><permission>hudson.model.Item.Configure:bozhou</permission><permission>hudson.model.Item.Configure:ltruong</permission><permission>hudson.model.Item.Configure:tkhoo</permission><permission>hudson.model.Item.Configure:lolu</permission><permission>hudson.model.Item.Build:kejiang</permission><permission>hudson.model.Item.Build:tkahkonen</permission><permission>hudson.model.Item.Build:richuang</permission><permission>hudson.model.Item.Build:ltruong</permission><permission>hudson.model.Item.Build:tkhoo</permission><permission>hudson.model.Item.Build:anonymous</permission><permission>hudson.model.Item.Build:jvely</permission><permission>hudson.model.Item.Build:rlux</permission><permission>hudson.model.Item.Build:biwei</permission><permission>hudson.model.Item.Build:belzhang</permission><permission>hudson.model.Item.Build:sochoudhary</permission><permission>hudson.model.Item.Build:bozhou</permission><permission>hudson.model.Item.Build:lolu</permission><permission>hudson.model.Run.Delete:kejiang</permission><permission>hudson.model.Run.Delete:jvely</permission><permission>hudson.model.Run.Delete:rlux</permission><permission>hudson.model.Run.Delete:tkahkonen</permission><permission>hudson.model.Run.Delete:biwei</permission><permission>hudson.model.Run.Delete:sochoudhary</permission><permission>hudson.model.Run.Delete:belzhang</permission><permission>hudson.model.Run.Delete:richuang</permission><permission>hudson.model.Run.Delete:bozhou</permission><permission>hudson.model.Run.Delete:ltruong</permission><permission>hudson.model.Run.Delete:tkhoo</permission><permission>hudson.model.Run.Delete:lolu</permission><permission>hudson.model.Item.Read:kejiang</permission><permission>hudson.model.Item.Read:jvely</permission><permission>hudson.model.Item.Read:rlux</permission><permission>hudson.model.Item.Read:tkahkonen</permission><permission>hudson.model.Item.Read:biwei</permission><permission>hudson.model.Item.Read:sochoudhary</permission><permission>hudson.model.Item.Read:belzhang</permission><permission>hudson.model.Item.Read:richuang</permission><permission>hudson.model.Item.Read:bozhou</permission><permission>hudson.model.Item.Read:ltruong</permission><permission>hudson.model.Item.Read:tkhoo</permission><permission>hudson.model.Item.Read:lolu</permission><permission>hudson.model.Item.ExtendedRead:kejiang</permission><permission>hudson.model.Item.ExtendedRead:jvely</permission><permission>hudson.model.Item.ExtendedRead:rlux</permission><permission>hudson.model.Item.ExtendedRead:tkahkonen</permission><permission>hudson.model.Item.ExtendedRead:biwei</permission><permission>hudson.model.Item.ExtendedRead:sochoudhary</permission><permission>hudson.model.Item.ExtendedRead:belzhang</permission><permission>hudson.model.Item.ExtendedRead:richuang</permission><permission>hudson.model.Item.ExtendedRead:bozhou</permission><permission>hudson.model.Item.ExtendedRead:ltruong</permission><permission>hudson.model.Item.ExtendedRead:tkhoo</permission><permission>hudson.model.Item.ExtendedRead:lolu</permission><permission>hudson.model.Run.Update:kejiang</permission><permission>hudson.model.Run.Update:jvely</permission><permission>hudson.model.Run.Update:rlux</permission><permission>hudson.model.Run.Update:tkahkonen</permission><permission>hudson.model.Run.Update:biwei</permission><permission>hudson.model.Run.Update:sochoudhary</permission><permission>hudson.model.Run.Update:belzhang</permission><permission>hudson.model.Run.Update:richuang</permission><permission>hudson.model.Run.Update:bozhou</permission><permission>hudson.model.Run.Update:ltruong</permission><permission>hudson.model.Run.Update:tkhoo</permission><permission>hudson.model.Run.Update:lolu</permission><permission>hudson.model.Item.Cancel:kejiang</permission><permission>hudson.model.Item.Cancel:tkahkonen</permission><permission>hudson.model.Item.Cancel:richuang</permission><permission>hudson.model.Item.Cancel:ltruong</permission><permission>hudson.model.Item.Cancel:tkhoo</permission><permission>hudson.model.Item.Cancel:anonymous</permission><permission>hudson.model.Item.Cancel:jvely</permission><permission>hudson.model.Item.Cancel:rlux</permission><permission>hudson.model.Item.Cancel:biwei</permission><permission>hudson.model.Item.Cancel:belzhang</permission><permission>hudson.model.Item.Cancel:sochoudhary</permission><permission>hudson.model.Item.Cancel:bozhou</permission><permission>hudson.model.Item.Cancel:lolu</permission></hudson.security.AuthorizationMatrixProperty>"
#    goalsStr = "clean test -U -DstageName=${stageName} -DBLUEFIN_SELENIUM_HOST=10.57.88.98 -DBLUEFIN_HOSTNAME=${stageName}.${stageDomain}.paypal.com -DBLUEFIN_SSH_USER=${SSH_USER} -DJAWS_DEFAULT_EMAIL_PREFIX=%s -DJAWS_NIGHTOWL_MAIL_SERVER=nightowllvs01.qa.paypal.com -DsuiteXmlFile=%s %s"
    goalsStr = "clean test -U -DstageName=${stageName} -DBLUEFIN_HOSTNAME=${stageName}.${stageDomain}.paypal.com -DBLUEFIN_SSH_USER=${SSH_USER} -DJAWS_DEFAULT_EMAIL_PREFIX=%s -DsuiteXmlFile=%s %s"
    email_notfication= """
...
#    """
    ...
    """  
    # stageName, SSH_USER, %s_DEFAULT_EMAIL_PREFIX, FAILED_JOBS_NOTIFICATION
    predefinedParams = """
        <hudson.model.ParametersDefinitionProperty><parameterDefinitions><hudson.model.StringParameterDefinition><name>stageName</name><description/><defaultValue>stage2dev463</defaultValue></hudson.model.StringParameterDefinition><hudson.model.StringParameterDefinition><name>stageDomain</name><description/><defaultValue>qa</defaultValue></hudson.model.StringParameterDefinition><hudson.model.StringParameterDefinition><name>SSH_USER</name><description/><defaultValue>ppbuild</defaultValue></hudson.model.StringParameterDefinition><hudson.model.StringParameterDefinition><name>%s_DEFAULT_EMAIL_PREFIX</name><description>Destination email prefix where the test case emails will be sent to and also will be notified when this job is Unstable,Failure,Still Failing,Success,Fixed or Still Unstable.</description><defaultValue>%s</defaultValue></hudson.model.StringParameterDefinition><hudson.model.StringParameterDefinition><name>FAILED_JOBS_NOTIFICATION</name><description>whom will be notified when this job is Unstable,Failure,Still Failing,or Still Unstable. This can be a emails list.</description><defaultValue>%s</defaultValue></hudson.model.StringParameterDefinition></parameterDefinitions></hudson.model.ParametersDefinitionProperty>
    """ 
    for jobName in jobsName:
